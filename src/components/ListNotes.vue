...
<template>
  <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4 gap-5 h-[530px] overflow-y-scroll shadow-inner p-4 border">
    <div v-for="(note,key) in notes" class="rounded card">
